...
function snowglass_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'snowglass' ),
	) );
 ...
 */
function snowglass_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'snowglass_content_width', 640 );
}
add_action( 'after_setup_theme', 'snowglass_content_width', 0 );
...
function snowglass_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'snowglass' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'snowglass' ),
...
function snowglass_scripts() {
	...
	wp_enqueue_script( 'snowglass-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'snowglass-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
